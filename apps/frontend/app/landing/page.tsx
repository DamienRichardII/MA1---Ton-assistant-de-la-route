...
// Sprint 0 — CTAs routent vers l'app standalone (cible app: Next.js, standalone gardé temporairement).
// Auto-École : mailto pour éviter le cul-de-sac UX. Tunnel Stripe à brancher en Sprint 3.
const APP_URL = '/index-standalone.html';
const SALES_MAIL = 'mailto:contact@ma1.app?subject=Demande%20Auto-%C3%A9cole%20MA1';
const PRICING = [
  { name: 'Gratuit', price: '0€', period: '', features: ['10 questions IA / jour', 'QCM adaptatifs', '1 examen blanc / mois', 'Analyse de panneaux', 'Plan 30 jours'], cta: 'Commencer gratuitement', href: APP_URL, featured: false },
  { name: 'Premium', price: '10€', period: '/mois', features: ['Questions illimitées', 'Tous les thèmes', 'Examens blancs illimités', 'Streaming temps réel', '7 jours d\'essai gratuit'], cta: '7 jours gratuits', href: APP_URL, featured: true },
  { name: 'Premium Annuel', price: '79€', period: '/an', features: ['Tout Premium', '2 mois offerts', '6,58€/mois au lieu de 10€', 'Économisez 41€', 'Accès garanti 12 mois'], cta: 'Économiser 41€', href: APP_URL, featured: false },
  { name: 'Auto-École', price: '200€', period: '/mois', features: ['Tout Premium', 'Dashboard moniteur', 'Suivi de 30 élèves', 'Export PDF progression', 'White-label personnalisable'], cta: 'Contacter les ventes', href: SALES_MAIL, featured: false },
];
  ...
  return (
    <div className="min-h-screen bg-[#0a1628] text-[#d0eaf2] overflow-x-hidden">
      ...
      <section className="relative py-20 px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href={APP_URL} className="px-8 py-4 rounded-full bg-gradient-to-br from-[#3a9db0] to-[#7ec8e3] text-white font-display font-bold text-base shadow-[0_4px_24px_rgba(58,157,176,0.4)] hover:-translate-y-0.5 transition-all">
      ...
      <section className="py-16 px-6 text-center">
        ...
        <Link href={APP_URL} className="inline-block px-10 py-4 rounded-full bg-gradient-to-br from-[#3a9db0] to-[#7ec8e3] text-white font-display font-bold text-base shadow-[0_4px_24px_rgba(58,157,176,0.4)] hover:-translate-y-0.5 transition-all">
